...
**Output diversity:** 17.9% mean pairwise size difference, 96.8% mean class-set difference between directions on the same source — no two tokens produce the same page.
