...
[![version 2.10.0](https://img.shields.io/badge/version-2.10.0-b22234.svg)](CHANGELOG.md)
...
No install required. Package: [npmjs.com/package/reimagine-it](https://www.npmjs.com/package/reimagine-it) · **2.10.0**.
...
curl -sLO https://github.com/Kayforkind/reimagine-it/releases/latest/download/reimagine-it-2.10.0.tgz
curl -sLO https://github.com/Kayforkind/reimagine-it/releases/latest/download/reimagine-it-2.10.0.tgz.sig

cosign verify-blob \
  --bundle reimagine-it-2.10.0.tgz.sig \
  --certificate-identity-regexp "https://github.com/Kayforkind/reimagine-it/" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com" \
  reimagine-it-2.10.0.tgz
